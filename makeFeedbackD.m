function out = makeFeedbackD(sys,param)
% function out = makeFeedbackD(sys,param)
%
% Synthesis State-feedback Control for Discrete (A,B_u,B_w,C,D_u) Polytopic System.
%
...
if nargin == 2
    ...
    if isfield(param,'pho')&&out.teorem~=3
        out.teorem=3;
    end
end
if takeToc==1
